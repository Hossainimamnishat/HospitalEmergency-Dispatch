...
public class EmergencyDispatchCenterTest {
    ...
    public void constructorTest () {
        var lst = new EmergencyDispatchCenter();
    }
    ...
    @Test
    public void dispatchTechnicalEmergencySmall() {
        EmergencyDispatchCenter lst = new EmergencyDispatchCenter();
        lst.addFireStation(new FireStation(1, "Da"));
        lst.getFireStations().get(0).getContent().addVehicle(FireTruckKinds.FireEngine);
        lst.getFireStations().get(0).getContent().addVehicle(FireTruckKinds.LadderTruck);
        lst.addCalltoList(lst.newCall("Da", EmergencyKinds.TechnicalEmergencySmall, 0, 0));
        assertTrue(lst.dispatchVehicles());
    }

    @Test
    public void dispatchHazmatEmergencySmall() {
        EmergencyDispatchCenter lst = new EmergencyDispatchCenter();
        lst.addFireStation(new FireStation(1, "Da"));
        lst.getFireStations().get(0).getContent().addVehicle(FireTruckKinds.FireEngine);
        lst.getFireStations().get(0).getContent().addVehicle(FireTruckKinds.FireEngine);
        lst.addCalltoList(lst.newCall("Da", EmergencyKinds.HazmatEmergencySmall, 0, 0));
        assertTrue(lst.dispatchVehicles());
    }

    @Test
    public void dispatchFireMiddle() {
        EmergencyDispatchCenter lst = new EmergencyDispatchCenter();
        lst.addFireStation(new FireStation(1, "Da"));
        lst.getFireStations().get(0).getContent().addVehicle(FireTruckKinds.FireEngine);
        lst.getFireStations().get(0).getContent().addVehicle(FireTruckKinds.FireEngine);
        lst.getFireStations().get(0).getContent().addVehicle(FireTruckKinds.FireEngine);
        lst.getFireStations().get(0).getContent().addVehicle(FireTruckKinds.LadderTruck);
        lst.getFireStations().get(0).getContent().addVehicle(FireTruckKinds.CommandVehicle);
        lst.addCalltoList(lst.newCall("Da", EmergencyKinds.FireMiddle, 0, 0));
        assertTrue(lst.dispatchVehicles());
    }

    @Test
    public void dispatchTechnicalEmergencyMiddle() {
        EmergencyDispatchCenter lst = new EmergencyDispatchCenter();
        lst.addFireStation(new FireStation(1, "Da"));
        lst.getFireStations().get(0).getContent().addVehicle(FireTruckKinds.RescueTruck);
        lst.getFireStations().get(0).getContent().addVehicle(FireTruckKinds.FireEngine);
        lst.getFireStations().get(0).getContent().addVehicle(FireTruckKinds.FireEngine);
        lst.getFireStations().get(0).getContent().addVehicle(FireTruckKinds.CommandVehicle);
        lst.addCalltoList(lst.newCall("Da", EmergencyKinds.TechnicalEmergencyMiddle, 0, 0));
        assertTrue(lst.dispatchVehicles());
    }

    @Test
    public void dispatchHazmatEmergencyMiddle() {
        EmergencyDispatchCenter lst = new EmergencyDispatchCenter();
        lst.addFireStation(new FireStation(1, "Da"));
        lst.getFireStations().get(0).getContent().addVehicle(FireTruckKinds.HazmatTruck);
        lst.getFireStations().get(0).getContent().addVehicle(FireTruckKinds.RescueTruck);
        lst.getFireStations().get(0).getContent().addVehicle(FireTruckKinds.FireEngine);
        lst.getFireStations().get(0).getContent().addVehicle(FireTruckKinds.FireEngine);
        lst.getFireStations().get(0).getContent().addVehicle(FireTruckKinds.CommandVehicle);
        lst.addCalltoList(lst.newCall("Da", EmergencyKinds.HazmatEmergencyMiddle, 0, 0));
        assertTrue(lst.dispatchVehicles());
    }

    @Test
    public void dispatchFireLarge() {
        EmergencyDispatchCenter lst = new EmergencyDispatchCenter();
        lst.addFireStation(new FireStation(1, "Da"));
        lst.getFireStations().get(0).getContent().addVehicle(FireTruckKinds.RescueTruck);
        lst.getFireStations().get(0).getContent().addVehicle(FireTruckKinds.FireEngine);
        ...
        lst.getFireStations().get(0).getContent().addVehicle(FireTruckKinds.LadderTruck);
        lst.getFireStations().get(0).getContent().addVehicle(FireTruckKinds.CommandVehicle);
        lst.addCalltoList(lst.newCall("Da", EmergencyKinds.FireLarge, 0, 0));
        assertTrue(lst.dispatchVehicles());
    }
